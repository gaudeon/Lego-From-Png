...
# ts/006_when_processing_pngs.t - Test aspects of module's process method
...
sub should_return_empty_list_with_no_params {
    ...
    mostly_like($result, { bricks => {}, plan => [] }, "Empty list returned");
}
...
sub should_only_return_bricks_in_the_list_that_are_whitelisted_by_color {
    ...
    mostly_like($result->{'plan'}[0], $expected, "Brick generated is of the whitelisted color we chose");
}
...
sub should_only_return_bricks_in_the_list_that_are_whitelisted_by_brick_dimension {
    ...
    mostly_like($result->{'plan'}, $expected, "Bricks generated are of the whitelisted dimensions we chose");
}
...
sub should_only_return_bricks_in_the_list_that_are_whitelisted_by_color_and_brick_dimension {
    ...
    mostly_like($result->{'plan'}, $expected, "Bricks generated are of the whitelisted color and dimenstions we chose");
}
...
sub should_return_information_about_the_generated_plan {
    ...
    mostly_like($result->{'info'}, $expected_in_millimeters, "Information about plan (in millimeters) correct");
